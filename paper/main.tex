...
\begin{table}[ht]
\centering
\caption{BK-Core Triton kernel performance. The Triton implementation achieves 185$\times$ speedup over PyTorch vmap, significantly exceeding the target of 3$\times$.}
...
\midrule
\textbf{Speedup} & \multicolumn{3}{c}{\textbf{185$\times$}} \\
\bottomrule
\end{tabular}
\end{table}
