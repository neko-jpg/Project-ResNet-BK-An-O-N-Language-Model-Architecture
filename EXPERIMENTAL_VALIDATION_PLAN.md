...
**期待される結果:**
- ResNet-BK INT4 PPL: 40-50
- Mamba INT4 PPL: 180-200
- 4×優位性の実証
...
**期待される結果:**
- ResNet-BK: 2.5 GFLOPs/token
- ResNet-BK+ACT: 1.8 GFLOPs/token
- Mamba: 3.2 GFLOPs/token
- 2×効率性の実証
