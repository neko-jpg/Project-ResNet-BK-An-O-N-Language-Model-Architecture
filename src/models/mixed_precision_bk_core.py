"""
Mixed-Precision BK-Core
Uses complex64 for gradients, complex128 for forward pass.
"""
...
class MixedPrecisionBKCoreFunction(torch.autograd.Function):
    ...
    def forward(ctx, he_diag, h0_super, h0_sub, z):
        """
        Forward pass in complex128 for numerical stability.
